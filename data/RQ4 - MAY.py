...
data=pd.read_csv('/Users/Enzopc/Desktop/yellow_tripdata_2018-05.csv', usecols=['passenger_count','PULocationID', 'DOLocationID','payment_type','total_amount'])
...
# 
# 
# 1: 6390662   2: 2769568    3: 50172    4: 13661
...
# The first value (10753.31) is the Chi-square value, followed by the p-value ~ 0, then comes the degrees of freedom (18), and lastly it outputs the expected frequencies as an array. 
