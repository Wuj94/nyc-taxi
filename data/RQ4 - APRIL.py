...
data=pd.read_csv('/Users/Enzopc/Desktop/yellow_tripdata_2018-04.csv', usecols=['passenger_count','PULocationID', 'DOLocationID','payment_type','total_amount'])
...
# 
# 
# 1: 6469399   2: 2772201    3: 50960    4: 12955
...
# The first value (12316.15) is the Chi-square value, followed by the p-value ~ 0, then comes the degrees of freedom (18), and lastly it outputs the expected frequencies as an array. 
