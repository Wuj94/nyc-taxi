...
data=pd.read_csv('/Users/Enzopc/Desktop/yellow_tripdata_2018-06.csv', usecols=['passenger_count','PULocationID', 'DOLocationID','payment_type','total_amount'])
...
# 
# 
# 1: 6050869   2: 2602098    3: 47332    4: 13532
...
# The first value ((10506.20) is the Chi-square value, followed by the p-value ~ 0, then comes the degrees of freedom (18), and lastly it outputs the expected frequencies as an array. 
